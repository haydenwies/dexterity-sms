...
type ScrollAreaBarProps = React.ComponentProps<typeof ScrollAreaPrimitive.ScrollAreaScrollbar>
const ScrollAreaBar = ({ className, orientation = "vertical", ...props }: ScrollAreaBarProps) => {
	return (
